...
namespace ProductManagementTests.ProductManagerCommands
{
    ...
    public class CountAllCommandTests
    {
        ...
        public void CountAllCommand_ConstructorTest_ThrowsCommandException()
        {
            CountAllCommand command = new CountAllCommand("average price");
        }

        [TestMethod()]
        public void CountAllCommand_Perform()
        {
            CountAllCommand command = new CountAllCommand("count all");
            List<Product> products = new List<Product>();

            string[] productInfo1 = { type1, name, quantity1, price1 };
            string[] productInfo2 = { type2, name, quantity2, price2 };
            string[] productInfo3 = { type2, name, quantity3, price3 };
